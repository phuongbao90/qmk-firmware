...
/*
   ...
   [_BASE] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_1,     KC_2,     KC_3,     KC_4,     QK_BOOT,                          KC_L,     KC_W,     KC_N,     KC_O,     KC_P,  
              KC_7,     KC_8,     KC_9,     KC_0,     KC_A,                          KC_Q,     KC_R,     KC_S,     KC_T,     KC_U,     
              KC_C,     KC_D,     KC_E,     KC_F,     KC_G,     QK_BOOT,   QK_BOOT,  KC_W,     KC_X,     KC_Y,     KC_Z,     KC_COMM,
                                            KC_I,     KC_J,     KC_K,      KC_SLSH,  KC_BSLS,  KC_SCLN
 )
};
