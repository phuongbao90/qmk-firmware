...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT(
       ...
       XXXXXXX,     XXXXXXX,    XXXXXXX,    XXXXXXX,     KC_BSLS,       KC_AMPR,               KC_TILD,     KC_RPRN,    KC_RCBR,     KC_RBRC,     KC_MINS,    XXXXXXX,
...
//   ),
  [_NUM] = LAYOUT(
       ...
       XXXXXXX,     KC_F1,      KC_F2  ,    KC_F3  ,     KC_F10 ,       XXXXXXX,               KC_0,        KC_1,       KC_P2,       KC_P3,       KC_MINS,    XXXXXXX,
